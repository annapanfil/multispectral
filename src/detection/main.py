...
from detection.utils import get_real_piles_size, greedy_grouping, prepare_image
...
def main():
    ...
    im_dir = "/home/anna/Datasets/annotated/green-net/images/train"
    model_path = "../models/pool-form1_pool-3-channels_random_best.pt"
    im_nr = "0004"
    altitude = 8 # TODO: get altitude and position from the ros topic or bag file
    debug = True
    ...
    # Read the aligned channels and convert to desired format
    # TODO: read raw and align
    im_aligned = load_aligned(im_dir, im_nr)
    image = prepare_image(im_aligned, channels, is_complex, new_image_size)
